...
class MoodAnalyzer:
    ...
    EMOTION_COLORS = {
        # Cool spectrum (left panel)
        "sad": {"color": "#4A90E2", "spectrum": "cool", "intensity": 0.8},
        "melancholy": {"color": "#5C7CFA", "spectrum": "cool", "intensity": 0.7},
        "peaceful": {"color": "#48C9B0", "spectrum": "cool", "intensity": 0.3},
        "calm": {"color": "#52C41A", "spectrum": "cool", "intensity": 0.2},
        "thoughtful": {"color": "#13C2C2", "spectrum": "cool", "intensity": 0.4},
        
        # Warm spectrum (right panel)
        "angry": {"color": "#F5222D", "spectrum": "warm", "intensity": 1.0},
        "passionate": {"color": "#FA541C", "spectrum": "warm", "intensity": 0.9},
        "excited": {"color": "#FA8C16", "spectrum": "warm", "intensity": 0.8},
        "frustrated": {"color": "#FF7A45", "spectrum": "warm", "intensity": 0.7},
        "enthusiastic": {"color": "#FFA940", "spectrum": "warm", "intensity": 0.6},
        
        # Neutral/balanced
        "happy": {"color": "#FADB14", "spectrum": "neutral", "intensity": 0.5},
        "content": {"color": "#A0D911", "spectrum": "neutral", "intensity": 0.3},
        "hopeful": {"color": "#52C41A", "spectrum": "neutral", "intensity": 0.4},
    }
    
    # Labels for GLiNER
    EMOTION_LABELS = [
        "happy", "angry", "sad", "excited", "calm", "frustrated", 
        "anxious", "joyful", "peaceful", "passionate", "melancholy",
        "enthusiastic", "thoughtful", "hopeful", "content"
    ]
    ...
    def _mock_entity_extraction(self, text: str) -> List[EmotionalEntity]:
        ...
        emotion_keywords = {
            "happy": ["happy", "joy", "glad", "delighted"],
